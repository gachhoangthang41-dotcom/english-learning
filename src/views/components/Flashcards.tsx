...
export default function Flashcards({ onScroll }: FlashcardsProps) {
  ...
  const flashcards: FlashcardData[] = [
    {
      level: t("savedShort"),
      title: t("flashcardsSavedTitle"),
      desc: t("flashcardsSavedDesc"),
      gradient: "bg-gradient-to-br from-emerald-600 to-[#0f172a]",
      href: "/flashcards/saved",
    },
    {
      level: t("knownShort"),
      title: t("flashcardsKnownTitle"),
      desc: t("flashcardsKnownDesc"),
      gradient: "bg-gradient-to-br from-[#047857] to-[#0f172a]",
      href: "/flashcards/known",
    },
    {
      level: t("unknownShort"),
      title: t("flashcardsUnknownTitle"),
      desc: t("flashcardsUnknownDesc"),
      gradient: "bg-gradient-to-br from-[#b45309] to-[#0f172a]",
      href: "/flashcards/unknown",
    },
    {
      level: "A1",
      title: t("flashcardsA1Title"),
      desc: t("flashcardsA1Desc"),
      gradient: "bg-gradient-to-br from-[#1e3a8a] to-[#0f172a]",
      href: "/flashcards/a1",
    },
    {
      level: "A2",
      title: t("flashcardsA2Title"),
      desc: t("flashcardsA2Desc"),
      gradient: "bg-gradient-to-br from-[#334155] to-[#0f172a]",
      href: "/flashcards/a2",
    },
    {
      level: "B1",
      title: t("flashcardsB1Title"),
      desc: t("flashcardsB1Desc"),
      gradient: "bg-gradient-to-br from-[#1f2937] to-[#030712]",
      href: "/flashcards/b1",
    },
    {
      level: "B2",
      title: t("flashcardsB2Title"),
      desc: t("flashcardsB2Desc"),
