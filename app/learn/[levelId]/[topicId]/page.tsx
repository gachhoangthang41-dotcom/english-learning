...
export default function LearnPage() {
  ...
  const handleGetTranscript = () => {
    ...
    setTimeout(() => {
      setTranscript(lessonData?.transcript || "Chưa có nội dung cho video này.");
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-xl md:text-2xl font-bold text-foreground">{lessonData?.title || `Unit ${params.topicId}`}</h1>
            </div>
          </div>
