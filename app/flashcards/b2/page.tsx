...
const B2_TOPICS: Topic[] = [
  {
    ...
    description: "Complex ideas and philosophical vocabulary",
    wordCount: 12,
  },
  {
    id: "technology",
    title: "Technology & Innovation",
    description: "Advanced tech and digital age vocabulary",
    wordCount: 12,
  },
  {
    id: "environment",
    title: "Environment & Sustainability",
    description: "Ecological and environmental vocabulary",
    wordCount: 12,
  },
  {
    id: "society",
    title: "Society & Culture",
    description: "Social structures and cultural concepts",
    wordCount: 12,
  },
];

export default function B2TopicsPage() {
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="mx-auto max-w-5xl px-5 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-xl font-bold">B2 Flashcard Topics</h1>
