...
import { LESSONS_BY_LEVEL } from "../../../../data/a1-lessons";
...
export default function DictationPage() {
    ...
    const lessonTitle = levelData && levelData[topicIdStr] ? levelData[topicIdStr].title : `Unit ${topicIdStr}`;
    ...
    currentSegmentRef.current = currentSegment; // sync immediately during render
    ...
    const handleTimeUpdate = () => {
        ...
        if (videoRef.current && !videoRef.current.paused && seg) {
            if (videoRef.current.currentTime >= seg.endTime) {
                videoRef.current.pause();
            }
        }
    };
                    ...
                    <div className="p-4 flex-1 overflow-y-auto">
                        ...
                        <div className="w-full aspect-video bg-black rounded-lg overflow-hidden shadow-2xl relative border border-slate-800">
                            <video
                                ...
                                controls
                                playsInline
                                src={`/videos/${params.levelId}/Lesson ${params.topicId}.mp4`}
