...
export const A1_LESSONS: Record<string, LessonContent> = {
  "1": {
    ...
    subtitle: "LESSON 1",
    videoSrc: "https://youtu.be/2RASDNWzg1w",
    ...
    segments: [
      ...
      { start: 6.2, end: 10.0, text: "Today's topic is introducing myself." },
      { start: 10.0, end: 14.7, text: "You will listen to a short story about a woman." },
      { start: 14.7, end: 23.0, text: "She will introduce herself and will give us personal information about her family and her life." },
      { start: 23.0, end: 30, text: "After the story, I will ask you some questions to check on your understanding." },
      { start: 30, end: 33.7, text: "Don't worry if you don't understand everything." },
      { start: 33.7, end: 36.8, text: "Just focus on the key information." },
      { start: 36.8, end: 38.0, text: "Are you ready?" },
      { start: 38.0, end: 40.5, text: "Let's begin." },
      { start: 40.5, end: 44.0, text: "Hello, my name is Emily." },
      { start: 44.0, end: 50.5, text: "I'm 40 years old and I live in a small town in the United States." },
      { start: 50.5, end: 54.5, text: "I want to tell you a little bit about myself." },
      { start: 54.5, end: 61.5, text: "I was born in New York City, but now I live in a town called Greenfield." },
      { start: 61.5, end: 64.7, text: "It's very quiet here and I love it." },
      { start: 64.7, end: 69.8, text: "The weather is nice and there are many parks and trees." },
      { start: 69.8, end: 77.8, text: "I live in a small house with my husband Tom and our two children, Lily and Ben." },
      { start: 77.8, end: 85.5, text: "Tom is 42 years old and he works in a big office in the city." },
      { start: 85.5, end: 90.0, text: "He is very busy, but he loves his job." },
      { start: 90.0, end: 97.0, text: "Lily is 9 years old and Ben is six." },
      { start: 97, end: 103, text: "Lily loves to draw and Ben loves to play with his toys." },
      { start: 103, end: 106.2, text: "I work as a nurse." },
      { start: 106.2, end: 110, text: "I help people when they are sick or hurt." },
      ...
      { start: 131, end: 137, text: "My favorite books are about history and travel." },
      { start: 137, end: 140, text: "I also enjoy cooking." },
      { start: 140, end: 144.8, text: "I like cooking Italian food, especially pasta." },
      { start: 144.8, end: 152.2, text: "On weekends, my family and I go for walks in the park." },
      { start: 152.2, end: 159, text: "We also visit my parents who live not far from us." },
      { start: 159, end: 166, text: "I have two sisters and we like to spend time together." },
      { start: 166, end: 171, text: "I think it's important to take care of our health." },
      { start: 171, end: 176, text: "I try to stay active by walking and eating healthy food." },
      { start: 176, end: 183, text: "I feel very lucky because I have a nice family and a lot of friends." },
      { start: 183, end: 186, text: "That's a little bit about me." },
      { start: 186, end: 190, text: "Thank you for listening." },
    ],
  },
  ...
  "2": {
    title: "My Family",
    subtitle: "LESSON 2",
    videoSrc: "https://youtu.be/MCNFxAoXqas",
    ...
    segments: [
      { start: 0, end: 7, text: "In this video, I will talk about the topic my family." },
      { start: 7, end: 15.8, text: "Listen carefully because later I will ask you some questions to see if you understood everything." },
      { start: 15.8, end: 17.7, text: "Are you ready?" },
      { start: 17.7, end: 20, text: "Let's start." },
      { start: 20, end: 22, text: "Hello everyone." },
      { start: 22, end: 24, text: "My name is Anna." },
      { start: 24, end: 29.8, text: "I'm very happy to share my family story with you today." },
      { start: 29.8, end: 36.3, text: "I come from a small and loving family and I want to tell you all about them." },
      { start: 36.3, end: 52.0, text: "I live with four people: my father, my mother, my older sister, and my younger brother." },
      { start: 52.0, end: 55.5, text: "My father's name is Mark." },
      { start: 55.5, end: 59.0, text: "He is a doctor." },
      { start: 59.0, end: 67.0, text: "Every day he works in a busy hospital and helps many people feel better." },
      { start: 67.0, end: 74.5, text: "I admire him because he is very kind and always takes care of others." },
      { start: 74.5, end: 85.0, text: "My father loves his job and he often tells me stories about how he helps his patients." },
      { start: 85.0, end: 89.7, text: "My mother's name is Linda." },
      { start: 89.7, end: 92.5, text: "She is a teacher." },
      { start: 92.5, end: 99.0, text: "She works in a local school where she teaches young children." },
      { start: 99.0, end: 104.0, text: "My mother is very patient and friendly." },
      { start: 104.0, end: 115.7, text: "She enjoys reading and writing and she always helps me with my homework when I study in the evening." },
      { start: 115.7, end: 123.6, text: "I feel very lucky to have such a caring and smart mother." },
      { start: 123.6, end: 127.4, text: "I also have an older sister." },
      { start: 127.4, end: 130.3, text: "Her name is Emily." },
      { start: 130.3, end: 134.1, text: "Emily is a high school student." },
      { start: 134.1, end: 138.5, text: "She studies hard and loves art." },
      { start: 138.5, end: 145, text: "In her free time, she likes to draw and paint." },
      { start: 145, end: 155.0, text: "Sometimes she shows me her beautiful pictures and I feel very proud of her." },
      { start: 155.0, end: 163.3, text: "Emily is very supportive and she always encourages me to try new things." },
      { start: 163.3, end: 166.5, text: "My younger brother is Tom." },
      { start: 166.5, end: 171.7, text: "He is 8 years old and full of energy." },
      { start: 171.7, end: 179, text: "Tom loves playing with his toys and riding his bicycle in the park." },
      { start: 179, end: 185.7, text: "He is always laughing and making everyone smile." },
      { start: 185.7, end: 199.5, text: "Even though he is younger, he is very curious and loves to ask questions about everything he sees." },
      { start: 199.5, end: 206.5, text: "Every morning, our family eats breakfast together." },
      { start: 206.5, end: 213.0, text: "We sit at the table and talk about our plans for the day." },
      { start: 213.0, end: 218.0, text: "After breakfast, my father leaves for the hospital." },
      { start: 218.0, end: 226.0, text: "My mother goes to school and my sister and I get ready for our studies." },
      { start: 226.0, end: 235.0, text: "In the afternoon, we sometimes meet at home and share our experiences." },
      { start: 235.0, end: 245.0, text: "In the evening, we have dinner together and enjoy simple happy moments." },
      { start: 245.0, end: 251.5, text: "On weekends, we like to spend time together outdoors." },
      { start: 251.5, end: 263.6, text: "We go for walks in the park and visit local markets or sometimes watch a movie together at home." },
      { start: 263.6, end: 269.9, text: "These moments make me feel very happy and connected with my family." },
      { start: 269.9, end: 275.0, text: "Thank you for listening to my story about my family." },
      { start: 275.0, end: 282.0, text: "I hope you enjoyed learning about each member and their daily lives." },
      { start: 282.0, end: 288.5, text: "I love my family and I am grateful for every day we spend together." },
    ],
  },
  ...
  "3": {
    ...
    subtitle: "LESSON 3",
    videoSrc: "https://youtu.be/Rtlsy80WAu0",
    transcript: `Hello. And welcome to this slow English listening for beginners. Today's topic is my daily routine. After the story, I will ask you some questions to check on your understanding. Don't worry if you don't understand everything, just focus on the key information. Are you ready? Let's begin. My name is Emma, I'm 40 years old. And today, I'm going to tell you about a typical day in my life. I have a simple routine, but I like it. I wake up at 7:00 in the morning. I don't like waking up early, but I have to, because I have a busy day. The first thing I do is turn off my alarm and get out of bed, I go to the bathroom. I wash my face and brush my teeth. After that I get dressed. I usually wear comfortable clothes because I work from home, I work on my computer all day. At 7:30 I go downstairs to have breakfast. I like to eat something light and healthy. I usually have cereal with milk and a cup of coffee. Sometimes I eat toast with jam and sometimes I have an apple. Breakfast is very important to me. It gives me energy for the entire day. At 8:00 I start working. I check my emails and answer some messages from my colleagues. I work as a freelance writer so I write articles for different companies. It's a nice job and I enjoy it. At 12:30, I have a break and have lunch. I don't eat a big lunch, just something small, like a salad or a sandwich. After lunch I like to take a short walk outside to get some fresh air. It helps me feel relaxed and ready for the afternoon. In the afternoon I work until 4:00. After I spend time with my family. At 6:00 I start preparing dinner, I like to cook. And try to make tasty meals for my family. Tonight I'm making pasta with tomato sauce. After dinner I clean the kitchen and then I try to relax. I usually read a book or watch TV. At 9:00 I help my children get ready for bed. I read a story to them and then they go to sleep. After I spend some time with my husband. We talk about our day or watch a movie together. I go to bed at 10:30. I need a good night sleep because I have another busy day tomorrow.`,
    segments: [
      { start: 0.407, end: 6.6, text: "Hello. And welcome to this slow English listening for beginners." },
      { start: 6.6, end: 10.027, text: "Today's topic is my daily routine." },
      { start: 10.8, end: 16.637, text: "After the story, I will ask you some questions to check on your understanding." },
      { start: 17.207, end: 23.957, text: "Don't worry if you don't understand everything, just focus on the key information." },
      { start: 24.5, end: 27.027, text: "Are you ready? Let's begin." },
      { start: 28.5, end: 32.747, text: "My name is Emma, I'm 40 years old." },
      { start: 33.0, end: 39.867, text: "And today, I'm going to tell you about a typical day in my life." },
      { start: 40.0, end: 44.207, text: "I have a simple routine, but I like it." },
      { start: 44.5, end: 48.977, text: "I wake up at 7:00 in the morning." },
      { start: 48.5, end: 54.437, text: "I don't like waking up early, but I have to, because I have a busy day." },
      { start: 54.600, end: 64.5, text: "The first thing I do is turn off my alarm and get out of bed, I go to the bathroom." },
      { start: 64.5, end: 71.2, text: "I wash my face and brush my teeth. After that I get dressed." },
      { start: 71.2, end: 77.4, text: "I usually wear comfortable clothes because I work from home," },
      { start: 77.4, end: 82.3, text: "I work on my computer all day." },
      { start: 82.3, end: 89.2, text: "At 7:30 I go downstairs to have breakfast." },
      { start: 89.2, end: 93.8, text: "I like to eat something light and healthy." },
      { start: 93.8, end: 100.0, text: "I usually have cereal with milk and a cup of coffee." },
      { start: 100.0, end: 107.8, text: "Sometimes I eat toast with jam and sometimes I have an apple." },
      { start: 107.8, end: 112.0, text: "Breakfast is very important to me." },
      { start: 112.0, end: 116.5, text: "It gives me energy for the entire day." },
      { start: 116.5, end: 120.5, text: "At 8:00 I start working." },
      { start: 120.5, end: 126.0, text: "I check my emails and answer some messages from my colleagues." },
      { start: 126.0, end: 134.5, text: "I work as a freelance writer so I write articles for different companies." },
      { start: 134.5, end: 139.4, text: "It's a nice job and I enjoy it." },
      { start: 139.4, end: 145.5, text: "At 12:30, I have a break and have lunch." },
      { start: 145.5, end: 152.5, text: "I don't eat a big lunch, just something small, like a salad or a sandwich." },
      { start: 152.5, end: 159.2, text: "After lunch I like to take a short walk outside to get some fresh air." },
      { start: 159.2, end: 164.0, text: "It helps me feel relaxed and ready for the afternoon." },
      { start: 164.0, end: 169.2, text: "In the afternoon I work until 4:00." },
      { start: 169.2, end: 173.6, text: "After that I spend time with my family." },
      { start: 173.6, end: 179.2, text: "At 6:00 I start preparing dinner, I like to cook." },
      { start: 179.2, end: 184.2, text: "and try to make tasty meals for my family." },
      { start: 184.2, end: 189.3, text: "Tonight I'm making pasta with tomato sauce." },
      { start: 189.3, end: 195.8, text: "After dinner I clean the kitchen and then I try to relax." },
      { start: 195.8, end: 201.0, text: "I usually read a book or watch TV." },
      { start: 201.0, end: 207.2, text: "At 9:00 I help my children get ready for bed." },
      { start: 207.2, end: 213.0, text: "I read a story to them and then they go to sleep." },
      { start: 213.0, end: 217.8, text: "After that I spend some time with my husband." },
      { start: 217.8, end: 224.5, text: "We talk about our day or watch a movie together." },
      { start: 224.5, end: 229.2, text: "I go to bed at 10:30." },
      { start: 229.2, end: 238.0, text: "I need a good night's sleep because I have another busy day tomorrow." },
    ],
  },
