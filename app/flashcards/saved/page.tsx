...
import { recordFlashcardReview } from '@/controllers/flashcards';
...
export default function SavedFlashcardsPage() {
    ...
    const handleReview = (status: "known" | "unknown") => {
        ...
        void recordFlashcardReview({
            ...
            console.error("Failed to record saved flashcard review:", error);
        });
