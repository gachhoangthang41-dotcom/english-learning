...
export const A1_LESSONS: Record<string, LessonContent> = {
  "1": {
    ...
    segments: [
      ...
      { start: 9.7, end: 14.7, text: "You will listen to a short story about a woman." },
      { start: 14.8, end: 23.4, text: "She will introduce herself and will give us personal information about her family and her life." },
      { start: 23.4, end: 29, text: "After the story, I will ask you some questions to check on your understanding." },
      { start: 29, end: 34.0, text: "Don't worry if you don't understand everything." },
      { start: 34.0, end: 36.8, text: "Just focus on the key information." },
      ...
      { start: 140, end: 145, text: "I like cooking Italian food, especially pasta." },
      { start: 145, end: 153, text: "On weekends, my family and I go for walks in the park." },
      { start: 153, end: 159, text: "We also visit my parents who live not far from us." },
