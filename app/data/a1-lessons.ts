...
export const A1_LESSONS: Record<string, LessonContent> = {
  "1": {
    ...
    segments: [
      ...
      { start: 9.7, end: 20, text: "You will listen to a short story about a woman. She will introduce herself and will give us personal information about her family and her life." },
      { start: 20, end: 22, text: "After the story, I will ask you some questions to check on your understanding." },
      { start: 22, end: 28, text: "Don't worry if you don't understand everything." },
      { start: 28, end: 30, text: "Just focus on the key information." },
      { start: 30, end: 33, text: "Are you ready? Let's begin." },
      { start: 33, end: 35, text: "Hello, my name is Emily." },
      { start: 35, end: 41, text: "I'm 40 years old and I live in a small town in the United States." },
      { start: 41, end: 44, text: "I want to tell you a little bit about myself." },
      { start: 44, end: 49, text: "I was born in New York City, but now I live in a town called Greenfield." },
      { start: 49, end: 55, text: "It's very quiet here and I love it. The weather is nice and there are many parks and trees." },
      { start: 55, end: 60, text: "I live in a small house with my husband Tom and our two children, Lily and Ben." },
      { start: 60, end: 62, text: "Tom is 42 years old." },
      { start: 62, end: 68, text: "And he works in a big office in the city. He is very busy, but he loves his job." },
      { start: 68, end: 76, text: "Lily is 9 years old and Ben is six. Lily loves to draw and Ben loves to play with his toys." },
      { start: 76, end: 83, text: "I work as a nurse. I help people when they are sick or hurt." },
      { start: 83, end: 88, text: "I work in a hospital in the city." },
      { start: 88, end: 97, text: "My job is very important to me because I like to help people feel better. Sometimes it's a hard job, but I enjoyed it a lot." },
      { start: 97, end: 103, text: "In my free time, I like to read books. My favorite books are about history and travel." },
      { start: 103, end: 107, text: "I also enjoy cooking. I like cooking Italian food, especially pasta." },
      { start: 107, end: 110, text: "On weekends, my family and I go for walks in the park." },
      { start: 110, end: 114, text: "We also visit my parents who live not far from us." },
      { start: 114, end: 121, text: "I have two sisters and we like to spend time together." },
      { start: 121, end: 128, text: "I think it's important to take care of our health. I try to stay active by walking and eating healthy food." },
      { start: 128, end: 131, text: "I feel very lucky because I have a nice family and a lot of friends." },
      { start: 131, end: 135, text: "That's a little bit about me." },
      { start: 135, end: 142, text: "Thank you for listening." },
    ],
  },
