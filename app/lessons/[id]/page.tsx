...
const coursesData: Record<string, CourseTopic[]> = {
  A1: [
    { id: 1, title: "Lesson 1 - Introducing myself", desc: "Giới thiệu bản thân cơ bản.", status: "active" },
    { id: 2, title: "Lesson 2 – My Family", desc: "Từ vựng về gia đình, giới thiệu người thân.", status: "active" },
    { id: 3, title: "Lesson 3 – A Day in My Life", desc: "Thói quen và hoạt động hàng ngày.", status: "active" },
    { id: 4, title: "Lesson 4 – My Favorite Food", desc: "Món ăn yêu thích và sở thích ăn uống.", status: "active" },
    { id: 5, title: "Lesson 5 – My Home", desc: "Miêu tả ngôi nhà và các phòng.", status: "active" },
    { id: 6, title: "Lesson 6 – My Favorite Hobby", desc: "Nói về sở thích cá nhân.", status: "active" },
    { id: 7, title: "Lesson 7 – My Pet", desc: "Giới thiệu thú cưng và thói quen của nó.", status: "active" },
    { id: 8, title: "Lesson 8 – The Weather Today", desc: "Nói về thời tiết hôm nay.", status: "active" },
    { id: 9, title: "Lesson 9 – My City", desc: "Miêu tả thành phố của bạn.", status: "active" },
    { id: 10, title: "Lesson 10 – A Special Friend", desc: "Nói về một người bạn đặc biệt.", status: "active" },
    { id: 11, title: "Lesson 11 – My School (My Favorite Subjects)", desc: "Giới thiệu trường học và môn học yêu thích.", status: "active" },
    { id: 12, title: "Lesson 12 – What I Do at the Weekend", desc: "Những việc bạn làm vào cuối tuần.", status: "active" },
    { id: 13, title: "Lesson 13 – My Favorite Sport", desc: "Nói về môn thể thao yêu thích.", status: "active" },
    { id: 14, title: "Lesson 14 – A day at the park", desc: "Một ngày đi công viên.", status: "active" },
    { id: 15, title: "Lesson 15 – What’s in my bag / backpack", desc: "Những thứ có trong cặp / ba lô.", status: "active" },
  ],
  A2: [
